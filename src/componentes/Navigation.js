...
const image = require("../img/Group 1.png");
...
const colors = {
  blue: "bg-gray-50 text-blue-500 rounded-full bg-opacity-50",
  orange: "bg-gray-50 text-orange-500 rounded-full bg-opacity-50",
  green: "bg-gray-50 rounded-full text-green-500 bg-opacity-50",
  "blue-gray": "bg-blue-gray-50 text-blue-gray-500 rounded-full bg-opacity-50" ,
  purple: "bg-gray-50 text-purple-500 rounded-full bg-opacity-50",
  teal: "bg-gray-50 text-teal-500 rounded-full bg-opacity-50 ",
  cyan: "bg-gray-50 text-cyan-500 rounded-full bg-opacity-50",
  pink: "bg-gray-50 text-pink-500 rounded-full bg-opacity-50",
};
...
function NavListMenu() {
  ...
  const renderItems = Categorias.map(
    ({ icon, title, description, color, hover }, key) => (
      <a href="#" key={key}>
        <MenuItem className={`flex items-center gap-2 rounded-lg hover:bg-gray-200 `}>
          ...
          <div>
            ...
            <Typography variant="small" color="gray" className="font-normal text text-left">
              {description}
            </Typography>
          </div>
        </MenuItem>
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <MenuList className="hidden max-w-lg m-2 p-2 rounded-xl lg:block bg-gray-200 bg-opacity-70 backdrop-blur-lg mt-4" >
...
export function Navigation() {
  ...
  return (
    <header>
    <nav className="top-0 left-0 right-0 m-3 shadow-2xl rounded-lg bg-gray-200 bg-opacity-50 backdrop-blur-lg fixed text-gray-800 z-10">
      <ul className="flex">
        <>
